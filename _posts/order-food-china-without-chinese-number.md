...
keywords:
  ...
  - "how to order food delivery in China without local number"
...
Before any of this works, you need Alipay set up with your foreign card. If you haven’t done that yet, sort it out first — it takes 10–30 minutes and unlocks basically everything else. → [How to Set Up Alipay as a Foreigner](/alipay-for-foreigners-china)
...
_Note: As of 2026, Ele.me has been rebranded as 淘宝闪购 (Taobao Instant). If you search “eleme” in Alipay, you’ll be redirected to Taobao Instant — same service, new name._
...
![Eleme food delivery interface inside Alipay app in China](/assets/blog/order-food-china-without-chinese-number/image-8.webp)
...
![Meituan app showing restaurant meal deal details and order management page in Chinese](/assets/blog/order-food-china-without-chinese-number/image-7.webp)
...
For a more detailed guide on ordering food with Meituan, browsing nearby food options, and making reservations, see this article: [How to Use Meituan for Foreigners In china (2026)](/how-to-use-meituan)
...
![Person scanning QR code at Chinese restaurant table to browse food menu on phone](/assets/blog/order-food-china-without-chinese-number/image-10.webp)
...
Internet is the second problem. The QR links to a live webpage or mini-program — no signal, nothing loads. → [China SIM Card & eSIM Guide](/china-sim-card-for-foreigners)
...
![Meituan food delivery rider on scooter with yellow delivery box in Chinese city](/assets/blog/order-food-china-without-chinese-number/image-9.webp)
...
![Traditional Chinese hotpot shared meal with multiple dishes and chopsticks on table](/assets/blog/order-food-china-without-chinese-number/image-11.webp)
