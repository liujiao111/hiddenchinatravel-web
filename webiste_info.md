...
不论大小页面、工具页还是内容页，设计与改版都必须遵守该规范（Sunshine 奶油底、Ocean Teal CTA、胶囊按钮、`rounded-2xl` 卡片 + 细顶色条）。首页不要做成 SaaS 功能卡落地页：信任与行前准备用编辑式清单，主 CTA 只保留一颗胶囊。已废弃：北欧极简（Scandinavian）、赤陶暖调（Terracotta）、旧海军蓝主按钮体系。
