...
export function KitPracticalSection() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-10 max-w-2xl text-sm font-light leading-relaxed text-[var(--brand-ink-muted)] md:text-base">
        {section.intro}
      </p>
      ...
      <div className="mb-12">
        ...
        <p className="mb-5 max-w-2xl text-sm font-light leading-relaxed text-[var(--brand-muted)]">
          {section.emergencyNote}
        </p>

        <div className="overflow-x-auto rounded-sm border border-[color-mix(in_srgb,var(--brand-cream-border)_40%,transparent)] bg-[var(--brand-surface)]">
          <table className="w-full min-w-[36rem] border-collapse text-left text-sm">
            ...
            <thead>
              <tr className="border-b border-[color-mix(in_srgb,var(--brand-cream-border)_40%,transparent)] bg-[var(--brand-soft)]">
                <th
                  scope="col"
                  className="px-4 py-3 text-[11px] font-light uppercase tracking-[0.14em] text-[var(--brand-muted)]"
                >
                  Service
                </th>
                <th
            ...
            <tbody>
              {section.emergencies.map((row) => (
                ...
                >
                  <td className="px-4 py-3.5 font-light tracking-wide text-[var(--brand-ink)]">
                    {row.service}
                  </td>
                  <td className="px-4 py-3.5 font-light tabular-nums tracking-wide text-[var(--brand-cta)]">
                    <a
                      href={`tel:${row.number}`}
                  ...
                  <td className="px-4 py-3.5 font-light tracking-wide text-[var(--brand-ink-muted)]">
                    {row.chinese}
                  </td>
                  <td className="px-4 py-3.5 font-light leading-relaxed text-[var(--brand-ink-muted)]">
                    {row.when}
                  </td>
                </tr>
              ))}
      ...
      <div>
        <h3 className="mb-5 text-base font-light tracking-wide text-[var(--brand-ink)] md:text-lg">
          {section.factsTitle}
        </h3>
        <div className="overflow-hidden rounded-sm border border-[color-mix(in_srgb,var(--brand-cream-border)_40%,transparent)] bg-[var(--brand-surface)]">
          <dl>
            {section.facts.map((fact, index) => (
              ...
              >
                <div className="grid gap-2 px-4 py-5 md:grid-cols-[11rem_1fr] md:gap-8 md:px-5 md:py-6">
                  <dt className="text-sm font-light tracking-wide text-[var(--brand-ink)]">
                    {fact.topic}
                  </dt>
                  <dd className="text-sm font-light leading-relaxed text-[var(--brand-ink-muted)]">
                    <p>{fact.answer}</p>
