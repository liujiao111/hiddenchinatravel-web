...
export function ServicesStickyCta() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] md:p-4">
      <div className="pointer-events-auto mx-auto flex max-w-lg items-center justify-between gap-2 rounded-2xl border-2 border-[var(--brand-cta)]/20 bg-white/95 px-3 py-2.5 shadow-[0_8px_30px_rgba(80,40,24,0.22)] backdrop-blur-sm sm:rounded-full sm:gap-3 sm:px-4 sm:py-2">
