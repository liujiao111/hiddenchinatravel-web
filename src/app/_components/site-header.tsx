  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-200 bg-white">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center gap-4 px-4 md:h-16 md:gap-6 md:px-6 lg:px-8 xl:gap-8">
        <div className="relative z-10 shrink-0 bg-white pr-2">
          {/* No priority — avoid competing with page LCP (e.g. home hero) */}
          <SiteLogo size="sm" tone="onWhite" compactOnMobile />
        </div>
        ...
        <div className="relative z-10 ml-auto flex shrink-0 items-center gap-2.5 bg-white sm:gap-3 2xl:border-l 2xl:border-neutral-200 2xl:pl-4">
          ...
          <Link
            href="/search"
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 text-neutral-900 transition-colors duration-300 hover:bg-neutral-50 2xl:hidden"
